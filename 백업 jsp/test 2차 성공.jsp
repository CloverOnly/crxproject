        ...
        <script>			
			function formatDate() {
			       ...
			       if (dateInput) {
			           ...
			           document.getElementById('formattedDate').value = formattedDate; // 수정된 부분
			       } else {
			           document.getElementById('formattedDate').value = ''; // 수정된 부분
			       }
			   }
			...
			function fetchTicketInfo() {
				...
				xhr.open('GET', 'https://apis.data.go.kr/1613000/TrainInfoService/getStrtpntAlocFndTrainInfo?serviceKey=KOyx%2F5iXteTdFA1wcSF1KvBTsEQcHMa8cFsrBwLTM6EGpTydPaVEtn4IjjQrwiIxqBvpc%2Bqi4NM9izQQfHzT3w%3D%3D&pageNo=1&numOfRows=10&_type=json'
						+'&depPlaceId=NAT010000&arrPlaceId=NAT011668' + '&' + 'depPlandTime' + '=' + formattedDate + 
