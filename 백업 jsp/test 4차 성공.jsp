...
<body>
    ...
    <div class="all">
        ...
        <script>	
			...
			function seatTicket() {
			    window.name = "parentForm";
			    openWin1 = window.open("seat.do", "seat", "width=970, height=350, resizable=no, scrollbars=no");
			}
			function setChildText2() {
			    if (seat && !seat.closed) {
			        seat.document.getElementById("ccInput").value = document.getElementById("depplacename").value;
			    } else {
			        alert("창이 닫혔거나 열리지 않았습니다.");
			    }
			}
