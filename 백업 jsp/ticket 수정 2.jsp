    ...
    <div class="all">
		...
		<div class="mid">		   
			...
			<div class="rt" id="station">
			    ...
			    <input id="depplacename" name="depplacename" type="text" class="inp200" title="출발역" disabled>
			    ...
			    <input id="arrplacename" name="arrplacename" type="text" class="inp200" title="도착역" disabled>
            ...
            <div class="rt">
                ...
                &nbsp;
                <input class="form-check-input" type="radio" name="flexRadioDefault" id="" value="전체" checked>
				...
				&nbsp;&nbsp;
                <input class="form-check-input" type="radio" name="flexRadioDefault" id="17" value="SRT">
	...
	<script>	
		...
		function formatDate() {
		   ...
		   function fetchTicketInfo() {
		       ...
		       var trainType = document.querySelector('input[name="flexRadioDefault"]:checked').id;
		       var start = document.getElementById('depPlaceIdHidden').value;
		       var end = document.getElementById('arrPlaceIdHidden').value;
			   // 인원 정보 가져오기
			   var personnelCount = document.getElementById('hiddenPersonnel').value;
			   var childCount = document.getElementById('hiddenChild').value;
			   var totalCount = parseInt(personnelCount) + parseInt(childCount);
		       ...
		       console.log('출발역 코드:',start);    
		       console.log('도착역 코드:',end);
			   console.log('어른 인원 수:', personnelCount);
			   console.log('아이 인원 수:',childCount);
			   console.log('전체 인원 수:',totalCount);
		       console.log('출발일:',formattedDate);
		       console.log('열차 넘버:',trainType);
			   console.log('선택된 좌석: ' , seatType);
		                       ...
		                       if (items.length > 0) {
		                           ...
		                           items.forEach(function(item) {
		                               ...
		                               table += '<tr>' +
									       ...
									       '<td><button class="seat-btn" onclick="seatTicket(\'' + item.trainno + '\', \'' + item.depplacename + '\', \'' + item.arrplacename + '\', \'' + formattedTime + '\', \'' + formatted2Time + '\', \'' + hours + '시간 ' + minutes + '분\')">좌석 선택</button></td>' +
									       '<td>' + formattedTime + '</td>' +
		...
		function setChildValue() {
		    if (openWin1 && !openWin1.closed) {
		        ...
		        alert("창이 닫혔거나 열리지 않았습니다.");
		    }
		}

		function setChildValue2() {
		...
		//좌석 조회
		function seatTicket(trainno, depPlace, arrPlace, depTime, arrTime, duration) {
