...
INSERT INTO `reply` VALUES (1,'어린이 요금은 성인 요금의 90%로 책정되어 있습니다. 이용 시 참고 부탁드립니다.','2024-08-25',10005,2),(2,'다른 고객들의 이용에 불편을 끼쳐드릴 수 있어서 반려동물 탑승은 제한됩니다. 감사합니다.','2024-08-29',10006,3),(3,'현재까지는 계획이 없습니다. 어플을 사용하게 될 경우 미리 공지하겠습니다.','2024-08-29',10006,4),(4,'현재까지는 예정이 없습니다. 이용해 주셔서 감사합니다.','2024-08-29',10006,5),(5,'영업일 2~3일 정도 소요됩니다.','2024-08-29',10006,7),(6,'관광열차는 해당일 오전 12시까지 예약이 가능하며 이후 시간은 다음 날 예약이 가능합니다.','2024-08-29',10006,8);
