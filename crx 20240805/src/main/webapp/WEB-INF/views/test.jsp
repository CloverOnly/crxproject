            ...
            <div>
                <div class="relist">
					...
					<div class="rt">
					    ...
					    <input id="arrplacename" name="arrplacename" type="text" class="inp200" value="NAT011668" title="출발역">
					    ...
					    <input id="depplacename" name="depplacename" type="text" class="inp200" value="NAT010000" title="도착역">
                    ...
                    <br>
                    <div class="search">
                        <button class="btn btn-primary" onclick="fetchTicketInfo()">조회</button>
                    </div>
        ...
        <script>
			function fetchTicketInfo() {
				...
				var queryParams = '?' + encodeURIComponent('serviceKey') + '=' + encodeURIComponent(serviceKey) +
					...
					'&' + encodeURIComponent('depPlandTime') + '=' + encodeURIComponent('20240805') +
