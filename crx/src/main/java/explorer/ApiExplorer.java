...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "http://apis.data.go.kr/1613000/TrainInfoService"); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("depPlandTime","UTF-8") + "=" + URLEncoder.encode("20240730", "UTF-8")); /*출발일(YYYYMMDD)*/
